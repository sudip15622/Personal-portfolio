...
const Contactbox = () => {
    return (
        <motion.section className='flex items-center justify-center bg-[var(--action-color)] py-20 px-[30px] relative left-1/2 -translate-x-1/2 w-[100vw]'
        ...
        >
            <div className='w-full max-w-[1250px] flex flex-col lg:flex-row lg:items-center lg:justify-between'>
                ...
                <motion.div className='hidden lg:flex items-center justify-center text-[25rem] -z-10'
    ...
    return (
        <>
            ...
            <footer className='flex items-center justify-center w-full z-[1000] bg-[var(--bg-color)]'>
                <div className='flex flex-col lg:flex-row w-full max-w-[1250px] mx-[30px]'>
                    <div className='flex flex-col flex-1 gap-5 pt-20 pb-10 border-b-[1px] lg:border-r-[1px] border-[var(--border-color)]'>
